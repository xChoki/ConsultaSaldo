...
async function scrapeWebsite(userInput) {
  ...
  await page.waitForSelector('.vlr', { timeout: 30000 })
...
// Versión deprecada scrappeando movired.cl se cambió porque no funciona la mayoría de las veces, se puede utilizar pero tener en consideración las limitaciones
// async function scrapeWebsite(userInput) {
//     const browser = await puppeteer.launch()
//     const page = await browser.newPage()
